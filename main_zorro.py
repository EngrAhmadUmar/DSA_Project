#Ahmad Ahmed
#Nnamuka  Ifeanyichukwu
#This is our DSA Project the music player..
...
status_bar = ttk.Label(root, text="Created by: Ahmad Ahmad & Nnamuka Ifeanyichukwu, 2020", relief=SUNKEN, anchor=W)
...
root.iconbitmap(r"Images\zorro.ico")
...
def about():
    messagebox.showinfo("About Zorro", "This is the Zorro Music Player, created as a school project by Ahmad Ahmad & Nnamuka Ifeanyichukwu. \n"
                                       "For more info: \n"
                                       "Email: a.ahmad@alustudent.com \n"
                                       "Email: i.nnamuka@alustudent.com \n"
                                       )
...
play_image = PhotoImage(file=r'Images\play.png')
stop_image = PhotoImage(file=r'Images\stop.png')
pause_image = PhotoImage(file=r'Images\pause.png')
rewind_image = PhotoImage(file=r'Images\rewind.png')
mute_image = PhotoImage(file=r'Images\mute.png')
unmute_image = PhotoImage(file=r'Images\unmute.png')
